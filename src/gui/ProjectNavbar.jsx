...
const INITIAL_CHECKPOINTS = [
    { label: 'manual', date: '20260323_005610_119', notes: '', filename: 'cp_manual_20260323_005610_119.zip' },
    { label: 'manual', date: '20260323_005603_076', notes: '', filename: 'cp_manual_20260323_005603_076.zip' },
    { label: 'auto_close', date: '20260321_014357_493', notes: 'Automatic checkpoint on clean close.', filename: 'cp_auto_close_20260321_014357_493.zip' },
    { label: 'auto_close', date: '20260301_220735_745', notes: 'Automatic checkpoint on clean close.', filename: 'cp_auto_close_20260301_220735_745.zip' },
    { label: 'initial', date: '20260301_220730_424', notes: 'Project created.', filename: 'cp_initial_20260301_220730_424.zip' }
];

const ProjectNavbar = ({ onLogout, setActiveNode }) => {
    const [showSaveModal, setShowSaveModal] = useState(false);
    const [showManagerModal, setShowManagerModal] = useState(false);
    const [checkpoints, setCheckpoints] = useState(INITIAL_CHECKPOINTS);

    const handleNewFromManager = () => {
        setShowManagerModal(false);
        setShowSaveModal(true);
    };

    const handleSaveCheckpoint = (newCP) => {
    ...
    return (
        <>
            <Navbar expand="lg" className="px-3 border-bottom custom-project-nav" style={{ 
                ...
                <Nav className="me-auto align-items-center">
                    <NavItemLink onClick={(e) => { e.preventDefault(); onLogout(); }}>Home</NavItemLink>
                    ...
                    <NavItemLink onClick={(e) => { e.preventDefault(); setActiveNode('Logs'); }}>Logs</NavItemLink>
                </Nav>
        ...
        <CheckpointManagerModal 
            ...
            onNewCheckpoint={handleNewFromManager} 
